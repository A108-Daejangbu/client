        ...
        <div className="p-1 md:p-2">
          ...
          <Calendar
            ...
            classNames={{
              ...
              nav_button:
                "h-5 w-5 md:h-6 md:w-6 bg-transparent p-0 opacity-50 hover:opacity-100",
              nav_button_previous: "absolute left-1",
              nav_button_next: "absolute right-1",
              table: "w-full border-collapse space-y-1",
              head_row: "flex justify-between w-full",
              head_cell:
                "text-gray-500 w-6 md:w-8 font-normal text-[0.6rem] md:text-[0.7rem] text-center",
        ...
        sections.map((section, sectionIndex) => (
          <div key={sectionIndex} className="w-[160px] md:w-[190px]">
            <div className="text-11 md:text-12 font-pre-medium mb-1 md:mb-2 px-2 md:px-3">
              <span className="text-main200">{section.title}</span>
            </div>
              ...
              return (
                ...
                >
                  {(!isSpecialOption || option.label.includes("숨기기")) && (
                    <div
                      className={`w-3.5 h-3.5 md:w-4 md:h-4 rounded transition-all ${
                        isSelected ? "bg-blue" : "border border-gray-300"
                  ...
                  <span
                    className={`text-11 md:text-12 font-pre-thin leading-none transition-colors ${
                      option.label.includes("삭제")
